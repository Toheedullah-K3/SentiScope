...
const Sidebar = ({ children }) => {
  ...
  return (
    <aside className="h-screen relative z-40">
      <nav className="relative h-full flex flex-col bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 border-r border-purple-500/30 shadow-xl backdrop-blur-md overflow-visible">
        ...
        <div className="p-4 pb-2 flex justify-between items-center">
          ...
          <button
            ...
            className="p-1.5 mx-auto rounded-lg text-gray-300 hover:bg-gradient-to-r hover:from-purple-600 hover:to-indigo-600 hover:text-white transition"
          >
        ...
        <div className="border-t border-purple-500/20 flex p-3">
          ...
          />
          <div
            className={`flex justify-between items-center transition-all duration-300 ${expanded ? "w-52 ml-3" : "w-0"}`}
          >
